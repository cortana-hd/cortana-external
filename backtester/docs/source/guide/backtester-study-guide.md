...
The compact operator reference now lives in [Market-data service reference](../../../knowledge/reference/market-data-service-reference.md).
...
- diagnostic and batch request shapes are documented in [Market-data service reference](../../../knowledge/reference/market-data-service-reference.md)
